...
$lblSub.Text = "설치 프로그램 v1.0"
$lblSub.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$lblPath.Text = "설치 위치:"
$lblPath.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$txtPath.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$btnBrowse.Text = "찾아보기"
$btnBrowse.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$chkDesktop.Text = "바탕화면 바로가기 생성"
$chkDesktop.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$chkStartMenu.Text = "시작 메뉴에 추가"
$chkStartMenu.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$lblStatus.Text = ""
$lblStatus.Font = New-Object System.Drawing.Font("맑은 고딕", 9)
...
$btnInstall.Text = "설치"
$btnInstall.Font = New-Object System.Drawing.Font("맑은 고딕", 10, [System.Drawing.FontStyle]::Bold)
...
$btnCancel.Text = "취소"
$btnCancel.Font = New-Object System.Drawing.Font("맑은 고딕", 10)
...
$btnInstall.Add_Click({
    ...
    try {
        ...
        $result = [System.Windows.Forms.MessageBox]::Show(
            "PIE 설치가 완료되었습니다.`n`n설치 위치: $InstallPath`n`n지금 PIE를 실행하시겠습니까?",
            "설치 완료", "YesNo", "Information")
        if ($result -eq "Yes") {
